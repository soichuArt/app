  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-geomanist text-gray-500">
    ...
    <div className="text-center mb-16 relative">
      ...
      <div className="flex justify-center mb-4">
        <button
onClick={() => window.location.href = '/PuebloBridge'}          className="px-8 py-3 bg-soichu-600 text-white rounded-lg shadow-lg font-light flex items-center space-x-2 hover:bg-soichu-700 transition"
        >

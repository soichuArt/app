    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-500 font-light max-w-3xl mx-auto leading-relaxed">
          A safe place to be yourself. <br /><br />*Pueblo, a country town, a village, a gentle place where everyone knows each other,
          <br />protects each other, and accepts each other. <br />That’s the spirit I’m weaving into this space:<br /> a virtual Pueblo where you can simply arrive, as you are.
 <br /><br />Soichu Pueblo is a community of presence, creativity, and care.<br />Rooted in truth, blossoming through connection. <br />This is just the beginning — the heart of Soichu, now finding its first home. <br />Feel free to share your life, your needs, your thoughts — whatever moves you.
          <br /><br />Thank you for being here. <br />Bienvenidxs. Let’s grow together.</p>
      </div>

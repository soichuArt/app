  ...
  const products = [
    {
      ...
      image: 'https://images.pexels.com/photos/6980523/pexels-photo-6980523.jpeg',
    ...
    },
    {
      ...
      featured: true,
      squareLink: 'https://square.link/u/ifgRipj6',
    ...
    },
    {
      ...
      category: 'artworks',
      price: 'Contact for Price',
      image: 'https://images.pexels.com/photos/6980542/pexels-photo-6980542.jpeg',
    ...
    },
    {
      ...
      category: 'oracle',
      price: 'Contact for Price',
      image: 'https://images.pexels.com/photos/6980537/pexels-photo-6980537.jpeg',
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mt-16 bg-gradient-to-r from-soichu-50 to-cream-50 rounded-lg p-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <button 
            onClick={() => window.open('https://soichu.com', '_blank')}
